...
export default class XandyBubble extends React.Component {
    ...
    render() {
        console.log('posision', this.props.position)
        return (
            <View
                style={[
...
XandyBubble.contextTypes = {
    actionSheet: PropTypes.func,
};

XandyBubble.defaultProps = {
    touchableProps: {},
    onLongPress: null,
